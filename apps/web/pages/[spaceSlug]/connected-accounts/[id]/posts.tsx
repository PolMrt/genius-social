...
import AccountPosts from "@/components/insights/account-posts";

function PostsAccountPage({ space }: any) {
  ...
  return (
    ...
    >
      ...
      <AccountPosts spaceSlug={space.slug} accountId={accountDetails.data.id} />
    </Sidebar>
  );
}

export default withAuth()(withSpaceData()(PostsAccountPage));
