...
function AudienceLocale({ values }: any) {
  ...
  return (
    <div>
      <BarChart
        value={allLocales}
        withShowMore={Object.keys(allLocales).length > 5}
      />
    </div>
  );
}
...
function AudienceCountries({ values }: any) {
  ...
  return (
    <BarChart
      value={allCountries}
      withShowMore={Object.keys(allCountries).length > 5}
    />
  );
}
  ...
  return (
    <Tabs
      tabs={[
        ...
        {
          name: "Men age range",
          child: <BarChart value={menAgeRange} />,
        },
        {
          name: "Female age range",
          child: <BarChart value={femaleAgeRange} />,
        },
      ]}
    />
  );
