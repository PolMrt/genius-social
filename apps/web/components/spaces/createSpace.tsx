...
export default function Createspace() {
  ...
  return (
    <>
      <button onClick={() => setOpen(true)}>Create new space</button>
                        ...
                        <div className="bg-dark-blue-700 py-6 px-4 sm:px-6">
                          ...
                          <div className="mt-1">
                            <p className="text-sm text-dark-blue-300">
                              ...
                              elit. Ad, quasi quos placeat beatae unde vel
                              impedit debitis quidem at. Itaque adipisci modi
                              placeat libero pariatur voluptatum reiciendis unde
                              facere accusamus?
                            </p>
                          </div>
                        </div>
